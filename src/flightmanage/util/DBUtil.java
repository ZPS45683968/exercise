...
//    private static final String URL = "jdbc:sqlserver://localhost:1433;DatabaseName=FlightManage";
...
//            System.out.println("数据库连接成功！");
    ...
    * 重载executeQuery方法，用于查询指定目的地的航班信息
    ...
    public static boolean executeUpdate(String sqlUpdate, FlightInfo flightInfo) {
        // 根据航班号更新航班信息
        PreparedStatement preparedStatement;
        boolean flag = false;
        try{
